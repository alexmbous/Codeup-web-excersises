(function(){
     ...
     * 'names'.
     */
    var names = ['Renee', 'Natalie', 'Bill', 'Ally'];
     ...
     */
    var namesArray = ['Renee', 'Natalie', 'Bill', 'Ally'];
  function firstName(input){
      return 'the first name is :' + input[0];
    }
  function secondName(input){
      return 'the second name is :' + input[1];
    }
  function lastName(input){
      return 'the last name is :' + input[input.length -1];
    }
    console.log(firstName(namesArray));
    console.log(secondName(namesArray));
    console.log(lastName(namesArray));



    // var potato = ['idaho', 'redb', 'yukon', 'marble', 'sweetpot', 'fingerling', 'purple'];
    // console.log(secondName(potato));
...
//
    ...
    var numbers = ['1','2','5','66','750','453','34543'], total=0;
