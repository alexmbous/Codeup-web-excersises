...
var books = [
        {title : "Adventures of Tin Tin", author : [ "Herge", ""]},
        {title : "The Jungle Book", author : ["Rudyard","Kipling"]},
        {title : "Husk", author : ["Sean", "Brock"]}
];
    books.forEach(function(book) {
            book.author.forEach(function() {
                console.log("the title is: " + book.title + ". The Author is:  " + book.author[0], book.author[1]);
            });
        });
